...
class DecoyWindow(QMainWindow):
    def __init__(self, text) -> None:
        ...
        - call DecoyWindow.set_text() to change the text on the window.
        """
        super().__init__()
    ...
    def set_text(self, text) -> None:
        """ method used to set the text on the label """
...
class MainTool(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        logger.debug('Adding scripting buttons...')
    ...
    def contextMenuEvent(self, event):
        ...
        if action is None: return
            ...
            self.add_new_button()
        elif (not self.is_small and action == actione and QMessageBox.question(self, 'PyAutoMate',
